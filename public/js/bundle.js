        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully!'); //if we have get data successfully then we will put 1.5 seconds delay and then we will load homepage right away using location.assign('/)
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error logging out! Try once again!');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2FodmRhbmltaXQiLCJhIjoiY2tjMWZtd3hmMDR3bzJxbWlldHg5bWdhZyJ9.k3s6tWrQmWJPbSyquG0kgA';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Sign up successfully!'); //if we have get data successfully then we will put 1.5 seconds delay and then we will load homepage right away using location.assign('/)
...
var stripe = Stripe('pk_test_51H0We0A9rCo3UqY6ZLnsbO6GjFlAeceF4UzvnXoPWKonWngdV9ieymNhHlhnnv1EfZiyyTQHcAMDgBoTNU2YeTTJ00SsbQS1N6');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.login').textContent = 'Processing'; //values
